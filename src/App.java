...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (int muestra : muestras) {
            ...
            Resultado resultadoInsertion = Benchmarking.medir(() -> sortMethods.insertionSort(copiaInsertion),
                    "Insertion Sort", muestra, "Ordenamiento de personas");
            System.out.println(resultadoInsertion);

            Resultado resultadoQuick = Benchmarking.medir(
                    () -> sortMethods.quickSort(copiaQuick, 0, copiaQuick.length - 1), "Quick Sort", muestra,
