...
public class SortPersonaMethods {
    ...
    public int partition(Persona[] personas, int low, int high) {
        ...
        // Se usa el elemento central como pivote
        int mid = (low + high) / 2;

        Persona tempPivot = personas[mid];
        personas[mid] = personas[high];
        personas[high] = tempPivot;
